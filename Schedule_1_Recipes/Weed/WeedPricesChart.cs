    ...
    internal sealed class WeedPricesChart(ComboBox ListDropdown, ComboBox PricesDropdown)
    {
        ...
        public void AddWeedPricesChart()
        {
            ...
            switch (SelectedWeed)
            {
                ...
                case "50": items = ["Strawberry Shart", "Miracle Slime"]; break;
                case "51": items = ["Ultra Cake", "Miracle Mint"]; break;
                ...
                case "57": items = ["Big Express", "Slimy Haze", "Stinky Cake", "White Assblaster"]; break;
                case "58": items = ["Fruity Ass", "Strawberry Cheese"]; break;
                case "59": items = ["California Smegma"]; break;
                case "60": items = ["Bio Bud", "Island Rhino", "Mega Bean", "Mega Monkey", "Stinky Cock"]; break;
                ...
                case "74": items = ["Big Express", "California Rhino", "Mega Diesel", "Thick Diamond"]; break;
                ...
                case "81": items = ["Fruity Haze", "Aspen Cookies"]; break;
                ...
                case "88": items = ["Big Ghost"]; break;
                case "90": items = ["Extreme Balls", "Nightmare Balls", "Thick Cock", "LA Urkle"]; break;
                ...
                case "94": items = ["Afghan Queef", "Afgham Queef", "Girl Scout Crystal", "Pink Ass", "Stawberry Cheese", "Stinky Puke", "Strawberry Shart", "Sweet ThunderFuck", "Shiny Mint", "Stinky Cock", "Tokyo Smegma", "LA Urkle", "Ice Cream Grool", "Dream Ass", "Girl Scout Monkey"]; break;
                ...
                case "115": items = ["Death Cock", "Ice Cream Grool"]; break;
                ...
                case "126": items = ["Sexy Diamond", "Stinky Cheese"]; break;
                ...
                case "147": items = ["Hairy Death", "Stinky Cheese", "Sexy Diamond"]; break;
                case "155": items = ["Dream Ass"]; break;
                case "161": items = ["LA Death"]; break;
                case "164": items = ["Girl Scout Punch"]; break;
                case "171": items = ["Girl Scout Monkey"]; break;
            }
        ...
        {
            string[] prices = ["41", "43", "47", "49", "50", "51", "52", "53", "54", "55", "57", "58", "59", "60", "61", "62", "64", "66", "67", "69", "70", "71", "72", "73", "74", "76", "77", "78", "81", "82", "83", "84", "85", "86", "87", "88", "90", "91", "92", "94", "95", "96", "97", "98", "99", "100", "101", "102", "104", "107", "108", "109", "110", "111", "113", "114", "115", "116", "117", "118", "120", "121", "126", "131", "136", "145", "146", "147", "155", "161", "164", "171"];
